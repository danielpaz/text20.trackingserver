 ...
 *
 */
package de.dfki.km.text20.trackingserver.eyes.adapter;
...
/**
 * General interface gaze adapters have to implement.
 *
 * @author Ralf Biedert
 */
public interface GazeAdapter extends CommonAdapter<TrackingEvent, TrackingDeviceInformation> {
    /**
     * 
     * @param command
     * @param options 
