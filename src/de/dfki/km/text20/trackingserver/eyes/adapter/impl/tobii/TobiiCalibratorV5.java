...
import de.dfki.km.text20.trackingserver.eyes.adapter.impl.tobii.diagnosis.channels.tracing.TobiiCalibratorTracer;
...
public class TobiiCalibratorV5 {
    ...
    private DiagnosisChannel<String> log;

    /**
     * @param tobiiGazeAdapter 
     * 
     */
    public TobiiCalibratorV5(TobiiGazeAdapter tobiiGazeAdapter) {
        ...
        this.log = tobiiGazeAdapter.diagnosis.channel(TobiiCalibratorTracer.class);
    }
    ...
    public void buildUp(final String tetServer, final int tetPort)
        ...
        if (this.calib == null)
            throw new EyetrackerException("creation of TetCalibProc object failed.");
        ...
        try {
            ...
            if (!this.calib.isConnected()) // no connection -> errror
                throw new EyetrackerException("connecting to tet server failed.");
    ...
    public void setCalibWindowVisibleAndTopmost(final boolean state) {
        ...
        try {
            ...
            this.log.status("calibwindowtopmost/visibility/exception", new OptionInfo("state", ""+state));
        }
        ...
        try {
            ...
            this.log.status("calibwindowtopmost/topmost/exception", new OptionInfo("state", ""+state));
        }
    }
    ...
    private void startCalibration() throws EyetrackerException {
        ...
        try {
            ...
            if (/* !this.calib.windowTopmost() || */!this.calib.windowVisible()
                ...
                this.log.status("startcalibration/notvisible");
                return;
            }
